...
export default function BeyondDeskSection() {
    ...
    return (
        <div className="gap-y-5 pt-5" >
            <p className="pt-2 text-sm font-primary text-vintage-lavender-300">
                    ...
                    {imageArr && (
                        imageArr.map((image, i) => (
                            <motion.div
                                ...
                                whileHover={{ y:-6}}
                                className="rounded-full w-58 h-68
            ...
            <p className="pt-10 text-sm font-primary text-vintage-lavender-300">
                Obligated internet pet tax: meet Finn. He's been my best friend for nearly a decade.
            </p>

            <p className="pt-5 text-sm font-primary text-vintage-lavender-300 items-start">
